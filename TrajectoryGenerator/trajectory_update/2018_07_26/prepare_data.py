...
regTree_bike_file = 'modTreeX_bike_test_pinv.dat'
...
#### build model
parameters_x = regNN.L_layer_model(train_x, train_x_target, layers_dims, optimizer = "adam", enable_mini_batch = True, 
                                   learning_rate = 0.01, num_iterations = 1000, print_cost = True)  


parameters_y = regNN.L_layer_model(train_y, train_y_target, layers_dims, optimizer = "adam", enable_mini_batch = True, 
                                   learning_rate = 0.01, num_iterations = 1000, print_cost = True)   
...
regNN_1234_x_file = 'regNN_1234_x_trained_v6_adam_minibatchON_last1.dat'
regNN_1234_y_file = 'regNN_1234_y_trained_v6_adam_minibatchON_last1.dat'
regNN.saveNetwork(parameters_x, model_path + regNN_1234_x_file)
regNN.saveNetwork(parameters_y, model_path + regNN_1234_y_file)
